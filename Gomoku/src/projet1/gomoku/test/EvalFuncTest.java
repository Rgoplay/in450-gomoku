...
public class EvalFuncTest {
	...
	public static void main(String[] args) {
		...
		int patternScore = new PatternEvalW6().evaluateBoard(board, Player.White);
		System.out.printf("1W | PatternEval %s\n", (patternScore == 20998)?"OK":"FAIL");
		patternScore = new PatternEvalW6().evaluateBoard(board, Player.Black);
		...
		patternScore = new PatternEvalW6().evaluateBoard(board, Player.White);
